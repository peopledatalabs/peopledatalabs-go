...
- Added job_posting_first_observed, job_posting_last_observed, resume_first_observed, resume_last_observed, inferred_first_used, and inferred_last_used to Company response TechnologiesUsed (PDL API v35.1)
