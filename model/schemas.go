...
type Company struct {
	...
	TopPreviousEmployers            map[string]map[string]int `json:"top_previous_employers"`              // The top ten previous companies employees worked for previously, and how many current employees were previously employed by them, across all time periods.
	TopNextEmployers                map[string]map[string]int `json:"top_next_employers"`                  // The top ten companies employees moved to, and how many employees moved there, across all time periods.
